...
<body>
                                            ...
                                            <div class="grid ">
                                                <div class="cart-page__product__select">                                               
                                                    <button class="btt" onclick="UpdateQuanlityCart('${base }', ${ci.productId}, -1)" value="-" type="button">-</button>
													      <strong><span data-price="${ci.priceUnit }"  id="quanlity_${ci.productId}">${ci.quanlity }</span></strong>
													<button class="btt" onclick="UpdateQuanlityCart('${base }', ${ci.productId}, 1)" value="+"  type="button">+</button>                   
                                                </div>
                                            </div>
                                            <%-- <div class="grid">
                                                <div class="cart-page__product__prices">
                                               		<fmt:setLocale value="vi_VN"/>
											         
											        <span id="totalPriceItem_${ci.productId}">
    ...
    $(document).ready(function() {
        var baseUrl = ${base}/ajax/updateQuanlityCart;
        var productId = productId;
        var quanlity = quanlity;
